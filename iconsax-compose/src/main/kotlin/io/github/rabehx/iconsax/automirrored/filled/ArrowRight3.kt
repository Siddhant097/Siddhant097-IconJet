...
val Iconsax.AutoMirrored.Filled.ArrowRight3: ImageVector
    get() {
        ...
        _ArrowRight3 = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                lineToRelative(-1.28f, -0.74f)
                curveTo(8.35f, 4.66f, 6f, 6.01f, 6f, 9.33f)
                close()
                moveTo(14f, 8.792f)
                ...
                lineToRelative(-1.1f, -0.64f)
                arcToRelative(0.503f, 0.503f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.75f, 0.44f)
                close()
            }
        }.build()
