...
val Iconsax.Filled.CloudMinus: ImageVector
    get() {
        if (_CloudMinus != null) {
            return _CloudMinus!!
        }
        _CloudMinus = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                close()
                moveTo(13.71f, 18.461f)
                horizontalLineTo(10.3f)
                curveTo(9.94f, 18.461f, 9.65f, 18.171f, 9.65f, 17.811f)
                curveTo(9.65f, 17.461f, 9.94f, 17.171f, 10.3f, 17.171f)
                horizontalLineTo(13.72f)
                curveTo(14.07f, 17.171f, 14.36f, 17.461f, 14.36f, 17.811f)
                curveTo(14.35f, 18.181f, 14.06f, 18.461f, 13.71f, 18.461f)
                close()
            }
        }.build()
