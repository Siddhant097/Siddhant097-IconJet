...
val Iconsax.Filled.Code2: ImageVector
    get() {
        if (_Code2 != null) {
            return _Code2!!
        }
        _Code2 = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(8.502f, 5.387f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.004f, -1.115f)
                lineTo(5.761f, 5.836f)
                curveToRelative(-0.737f, 0.663f, -1.347f, 1.212f, -1.767f, 1.71f)
                curveToRelative(-0.44f, 0.525f, -0.754f, 1.088f, -0.754f, 1.784f)
                curveToRelative(0f, 0.695f, 0.313f, 1.258f, 0.754f, 1.782f)
                curveToRelative(0.42f, 0.499f, 1.03f, 1.049f, 1.767f, 1.711f)
                lineToRelative(1.737f, 1.564f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = true, isPositiveArc = false, 1.004f, -1.115f)
                lineToRelative(-1.697f, -1.527f)
                curveToRelative(-0.788f, -0.709f, -1.319f, -1.19f, -1.663f, -1.598f)
                curveToRelative(-0.33f, -0.393f, -0.402f, -0.622f, -0.402f, -0.817f)
                curveToRelative(0f, -0.196f, 0.072f, -0.425f, 0.402f, -0.818f)
                curveToRelative(0.344f, -0.409f, 0.875f, -0.889f, 1.663f, -1.598f)
                close()
                moveTo(14.18f, 4.275f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.532f, 0.918f)
                lineToRelative(-3.987f, 15f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = true, isPositiveArc = true, -1.45f, -0.386f)
                lineToRelative(3.987f, -15f)
                ...
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = true, isPositiveArc = true, -1.004f, -1.116f)
