...
val Iconsax.Filled.GalleryFavorite: ImageVector
    get() {
        if (_GalleryFavorite != null) {
            return _GalleryFavorite!!
        }
        _GalleryFavorite = ImageVector.Builder(
            name = "Filled.GalleryFavorite",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(17.16f, 1f, 16.52f, 1.36f, 16.23f, 2f)
                curveTo(16.07f, 2.29f, 16f, 2.63f, 16f, 3.03f)
                verticalLineTo(3.5f)
                verticalLineTo(5.97f)
                curveTo(16f, 7.24f, 16.76f, 8f, 18.03f, 8f)
                horizontalLineTo(20.5f)
                horizontalLineTo(20.97f)
                curveTo(21.37f, 8f, 21.71f, 7.93f, 22f, 7.77f)
                curveTo(22.64f, 7.48f, 23f, 6.84f, 23f, 5.97f)
                verticalLineTo(3.03f)
                curveTo(23f, 1.76f, 22.24f, 1f, 20.97f, 1f)
                close()
                moveTo(20.3f, 6.21f)
                curveTo(19.98f, 6.4f, 19.67f, 6.5f, 19.5f, 6.5f)
                curveTo(19.05f, 6.5f, 17.77f, 5.88f, 17.39f, 4.68f)
                curveTo(17.33f, 4.5f, 17.3f, 4.3f, 17.3f, 4.11f)
                curveTo(17.3f, 3.94f, 17.32f, 3.77f, 17.37f, 3.61f)
                curveTo(17.5f, 3.14f, 17.81f, 2.73f, 18.33f, 2.56f)
                curveTo(18.53f, 2.5f, 18.74f, 2.48f, 18.93f, 2.52f)
                curveTo(19.13f, 2.55f, 19.32f, 2.63f, 19.49f, 2.76f)
                curveTo(19.81f, 2.51f, 20.25f, 2.43f, 20.67f, 2.56f)
                curveTo(21.58f, 2.86f, 21.87f, 3.89f, 21.61f, 4.68f)
                curveTo(21.57f, 4.8f, 21.52f, 4.92f, 21.46f, 5.03f)
                curveTo(21.19f, 5.57f, 20.73f, 5.97f, 20.3f, 6.21f)
                close()
            }
        }.build()
