...
val Iconsax.Filled.GalleryTick: ImageVector
    get() {
        if (_GalleryTick != null) {
            return _GalleryTick!!
        }
        _GalleryTick = ImageVector.Builder(
            name = "Filled.GalleryTick",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                moveTo(21.63f, 3.45f)
                lineTo(19.26f, 6.22f)
                curveTo(19.17f, 6.33f, 19.03f, 6.4f, 18.89f, 6.4f)
                curveTo(18.88f, 6.4f, 18.88f, 6.4f, 18.87f, 6.4f)
                curveTo(18.73f, 6.4f, 18.6f, 6.35f, 18.5f, 6.25f)
                lineTo(17.4f, 5.17f)
                curveTo(17.2f, 4.97f, 17.2f, 4.64f, 17.4f, 4.44f)
                curveTo(17.6f, 4.24f, 17.93f, 4.23f, 18.13f, 4.44f)
                lineTo(18.83f, 5.13f)
                lineTo(20.83f, 2.79f)
                curveTo(21.02f, 2.57f, 21.34f, 2.55f, 21.56f, 2.73f)
                curveTo(21.79f, 2.91f, 21.81f, 3.24f, 21.63f, 3.45f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
