...
val Iconsax.Filled.MusicSquareRemove: ImageVector
    get() {
        ...
        _MusicSquareRemove = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(12.228f, 12.07f)
                curveTo(11.818f, 12.07f, 11.488f, 12.4f, 11.488f, 12.81f)
                curveTo(11.488f, 13.22f, 11.818f, 13.55f, 12.228f, 13.55f)
                curveTo(12.638f, 13.55f, 12.968f, 13.22f, 12.968f, 12.81f)
                curveTo(12.968f, 12.4f, 12.638f, 12.07f, 12.228f, 12.07f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(6.76f, 13.059f)
                curveTo(6.35f, 13.059f, 6.02f, 13.389f, 6.02f, 13.799f)
                curveTo(6.02f, 14.209f, 6.35f, 14.539f, 6.76f, 14.539f)
                curveTo(7.17f, 14.539f, 7.5f, 14.209f, 7.5f, 13.799f)
                curveTo(7.5f, 13.389f, 7.17f, 13.059f, 6.76f, 13.059f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(16.19f, 2f)
