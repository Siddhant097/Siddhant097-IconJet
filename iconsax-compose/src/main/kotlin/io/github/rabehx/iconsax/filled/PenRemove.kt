...
val Iconsax.Filled.PenRemove: ImageVector
    get() {
        if (_PenRemove != null) {
            return _PenRemove!!
        }
        _PenRemove = ImageVector.Builder(
            name = "Filled.PenRemove",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(3.19f, 9.72f, 4.04f, 10.42f, 5.06f, 10.76f)
                ...
                curveTo(10.94f, 7.32f, 11f, 6.91f, 11f, 6.5f)
                curveTo(11f, 4.01f, 8.99f, 2f, 6.5f, 2f)
                close()
                moveTo(8.16f, 7.25f)
                horizontalLineTo(4.8f)
                curveTo(4.39f, 7.25f, 4.05f, 6.91f, 4.05f, 6.5f)
                curveTo(4.05f, 6.09f, 4.39f, 5.75f, 4.8f, 5.75f)
                horizontalLineTo(8.16f)
                curveTo(8.57f, 5.75f, 8.91f, 6.09f, 8.91f, 6.5f)
                curveTo(8.91f, 6.91f, 8.58f, 7.25f, 8.16f, 7.25f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(16f, 21.29f)
