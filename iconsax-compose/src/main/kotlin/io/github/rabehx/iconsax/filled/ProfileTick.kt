...
val Iconsax.Filled.ProfileTick: ImageVector
    get() {
        if (_ProfileTick != null) {
            return _ProfileTick!!
        }
        _ProfileTick = ImageVector.Builder(
            name = "Filled.ProfileTick",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                close()
                moveTo(14.331f, 16.561f)
                lineTo(11.811f, 19.081f)
                curveTo(11.691f, 19.201f, 11.531f, 19.261f, 11.371f, 19.261f)
                curveTo(11.211f, 19.261f, 11.051f, 19.191f, 10.931f, 19.081f)
                lineTo(9.671f, 17.821f)
                curveTo(9.431f, 17.581f, 9.431f, 17.181f, 9.671f, 16.941f)
                curveTo(9.911f, 16.701f, 10.311f, 16.701f, 10.551f, 16.941f)
                lineTo(11.371f, 17.761f)
                lineTo(13.451f, 15.681f)
                curveTo(13.691f, 15.441f, 14.091f, 15.441f, 14.331f, 15.681f)
                curveTo(14.581f, 15.921f, 14.581f, 16.321f, 14.331f, 16.561f)
                close()
            }
        }.build()
