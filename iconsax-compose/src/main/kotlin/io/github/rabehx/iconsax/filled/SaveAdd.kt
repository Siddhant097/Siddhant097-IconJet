...
val Iconsax.Filled.SaveAdd: ImageVector
    get() {
        if (_SaveAdd != null) {
            return _SaveAdd!!
        }
        _SaveAdd = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(9.75f, 14.409f, 9.41f, 14.749f, 9f, 14.749f)
                curveTo(8.59f, 14.749f, 8.25f, 14.409f, 8.25f, 13.999f)
                ...
                curveTo(8.25f, 9.589f, 8.59f, 9.249f, 9f, 9.249f)
                curveTo(9.41f, 9.249f, 9.75f, 9.589f, 9.75f, 9.999f)
