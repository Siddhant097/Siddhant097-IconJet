...
val Iconsax.Filled.ShopAdd: ImageVector
    get() {
        if (_ShopAdd != null) {
            return _ShopAdd!!
        }
        _ShopAdd = ImageVector.Builder(
            name = "Filled.ShopAdd",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                lineTo(21.7f, 5.932f)
                curveTo(21.3f, 3.032f, 19.98f, 1.852f, 17.16f, 1.852f)
                ...
                curveTo(7.12f, 12.902f, 8.28f, 12.292f, 9.01f, 11.322f)
                curveTo(9.66f, 12.292f, 10.78f, 12.902f, 12.02f, 12.902f)
                curveTo(13.26f, 12.902f, 14.35f, 12.322f, 15.01f, 11.362f)
                curveTo(15.75f, 12.312f, 16.89f, 12.902f, 18.09f, 12.902f)
                ...
                curveTo(12.75f, 8.932f, 12.41f, 9.262f, 12f, 9.262f)
                curveTo(11.59f, 9.262f, 11.25f, 8.932f, 11.25f, 8.512f)
                ...
                curveTo(11.25f, 5.112f, 11.59f, 4.772f, 12f, 4.772f)
                curveTo(12.41f, 4.772f, 12.75f, 5.112f, 12.75f, 5.522f)
