...
val Iconsax.Filled.TextalignCenter: ImageVector
    get() {
        ...
        _TextalignCenter = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(16.742f, 10.25f)
                horizontalLineTo(7.262f)
                curveTo(6.852f, 10.25f, 6.512f, 9.91f, 6.512f, 9.5f)
                curveTo(6.512f, 9.09f, 6.852f, 8.75f, 7.262f, 8.75f)
                horizontalLineTo(16.732f)
                curveTo(17.142f, 8.75f, 17.482f, 9.09f, 17.482f, 9.5f)
                curveTo(17.482f, 9.91f, 17.152f, 10.25f, 16.742f, 10.25f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(21f, 15.25f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(16.742f, 20.25f)
                horizontalLineTo(7.262f)
                curveTo(6.852f, 20.25f, 6.512f, 19.91f, 6.512f, 19.5f)
                curveTo(6.512f, 19.09f, 6.852f, 18.75f, 7.262f, 18.75f)
                horizontalLineTo(16.732f)
                curveTo(17.142f, 18.75f, 17.482f, 19.09f, 17.482f, 19.5f)
                curveTo(17.482f, 19.91f, 17.152f, 20.25f, 16.742f, 20.25f)
                close()
            }
        }.build()
