...
val Iconsax.Filled.TruckTime: ImageVector
    get() {
        if (_TruckTime != null) {
            return _TruckTime!!
        }
        _TruckTime = ImageVector.Builder(
            name = "Filled.TruckTime",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(2f, 12.63f, 2.45f, 13.08f, 3f, 13.08f)
                horizontalLineTo(12.15f)
                curveTo(13.17f, 13.08f, 14f, 12.25f, 14f, 11.23f)
                verticalLineTo(2.92f)
                curveTo(14f, 2.41f, 13.59f, 2f, 13.08f, 2f)
                close()
                moveTo(9.38f, 7.91f)
                curveTo(9.38f, 8.17f, 9.24f, 8.42f, 9.02f, 8.55f)
                lineTo(7.77f, 9.3f)
                curveTo(7.64f, 9.38f, 7.51f, 9.41f, 7.38f, 9.41f)
                curveTo(7.13f, 9.41f, 6.88f, 9.28f, 6.74f, 9.05f)
                curveTo(6.52f, 8.69f, 6.64f, 8.23f, 6.99f, 8.02f)
                lineTo(7.88f, 7.49f)
                verticalLineTo(6.41f)
                curveTo(7.88f, 6f, 8.22f, 5.66f, 8.63f, 5.66f)
                curveTo(9.04f, 5.66f, 9.38f, 6f, 9.38f, 6.41f)
