...
val Iconsax.Outline.Autobrightness: ImageVector
    get() {
        ...
        _Autobrightness = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(11.639f, 21.32f, 12.349f, 21.32f, 12.769f, 20.97f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(14.811f, 16.24f)
                lineTo(12f, 9.91f)
                lineTo(9.191f, 16.24f)
                lineTo(7.811f, 15.63f)
                lineTo(11.311f, 7.76f)
                horizontalLineTo(12.691f)
                lineTo(16.191f, 15.63f)
                lineTo(14.811f, 16.24f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(13.75f, 14.06f)
                horizontalLineTo(10.25f)
                curveTo(9.84f, 14.06f, 9.5f, 13.72f, 9.5f, 13.31f)
                curveTo(9.5f, 12.9f, 9.84f, 12.56f, 10.25f, 12.56f)
                horizontalLineTo(13.75f)
                curveTo(14.16f, 12.56f, 14.5f, 12.9f, 14.5f, 13.31f)
                curveTo(14.5f, 13.72f, 14.16f, 14.06f, 13.75f, 14.06f)
                close()
            }
        }.build()
