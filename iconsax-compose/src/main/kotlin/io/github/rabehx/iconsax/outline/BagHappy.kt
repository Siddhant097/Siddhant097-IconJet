...
val Iconsax.Outline.BagHappy: ImageVector
    get() {
        if (_BagHappy != null) {
            return _BagHappy!!
        }
        _BagHappy = ImageVector.Builder(
            name = "Outline.BagHappy",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(12f, 18.5f)
                curveTo(9.66f, 18.5f, 7.75f, 16.59f, 7.75f, 14.25f)
                curveTo(7.75f, 13.84f, 8.09f, 13.5f, 8.5f, 13.5f)
                curveTo(8.91f, 13.5f, 9.25f, 13.84f, 9.25f, 14.25f)
                curveTo(9.25f, 15.77f, 10.48f, 17f, 12f, 17f)
                curveTo(13.52f, 17f, 14.75f, 15.77f, 14.75f, 14.25f)
                curveTo(14.75f, 13.84f, 15.09f, 13.5f, 15.5f, 13.5f)
                curveTo(15.91f, 13.5f, 16.25f, 13.84f, 16.25f, 14.25f)
                curveTo(16.25f, 16.59f, 14.34f, 18.5f, 12f, 18.5f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(5.191f, 6.38f)
