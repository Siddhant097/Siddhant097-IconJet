...
val Iconsax.Outline.BagTick: ImageVector
    get() {
        if (_BagTick != null) {
            return _BagTick!!
        }
        _BagTick = ImageVector.Builder(
            name = "Outline.BagTick",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(11.12f, 18.25f)
                curveTo(10.931f, 18.25f, 10.741f, 18.18f, 10.59f, 18.03f)
                lineTo(9.091f, 16.53f)
                curveTo(8.801f, 16.24f, 8.801f, 15.76f, 9.091f, 15.47f)
                curveTo(9.381f, 15.18f, 9.861f, 15.18f, 10.151f, 15.47f)
                lineTo(11.141f, 16.46f)
                lineTo(13.861f, 13.95f)
                curveTo(14.16f, 13.67f, 14.641f, 13.69f, 14.92f, 13.99f)
                curveTo(15.2f, 14.29f, 15.181f, 14.77f, 14.88f, 15.05f)
                lineTo(11.63f, 18.05f)
                curveTo(11.491f, 18.18f, 11.311f, 18.25f, 11.12f, 18.25f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(5.191f, 6.38f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(3.781f, 9.19f, 4.171f, 9.47f, 4.241f, 9.88f)
