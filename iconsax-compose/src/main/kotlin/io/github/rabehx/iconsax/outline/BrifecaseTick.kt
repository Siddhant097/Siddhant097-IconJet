...
val Iconsax.Outline.BrifecaseTick: ImageVector
    get() {
        ...
        _BrifecaseTick = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(11.441f, 15.83f)
                curveTo(11.121f, 15.83f, 10.801f, 15.71f, 10.561f, 15.47f)
                lineTo(9.911f, 14.82f)
                curveTo(9.621f, 14.53f, 9.621f, 14.05f, 9.911f, 13.76f)
                curveTo(10.201f, 13.47f, 10.681f, 13.47f, 10.971f, 13.76f)
                lineTo(11.451f, 14.24f)
                lineTo(13.061f, 12.76f)
                curveTo(13.361f, 12.48f, 13.841f, 12.5f, 14.121f, 12.8f)
                curveTo(14.401f, 13.1f, 14.381f, 13.58f, 14.081f, 13.86f)
                lineTo(12.301f, 15.5f)
                curveTo(12.051f, 15.72f, 11.751f, 15.83f, 11.441f, 15.83f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(16f, 22.75f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(21.531f, 10.15f, 22f, 10.22f, 22.25f, 10.56f)
