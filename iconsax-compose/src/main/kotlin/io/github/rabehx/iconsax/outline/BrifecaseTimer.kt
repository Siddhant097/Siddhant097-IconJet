...
val Iconsax.Outline.BrifecaseTimer: ImageVector
    get() {
        ...
        _BrifecaseTimer = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(11f, 15.95f)
                curveTo(10.75f, 15.95f, 10.5f, 15.82f, 10.36f, 15.59f)
                curveTo(10.15f, 15.23f, 10.26f, 14.77f, 10.62f, 14.56f)
                lineTo(11.38f, 14.1f)
                curveTo(11.46f, 14.06f, 11.5f, 13.97f, 11.5f, 13.89f)
                verticalLineTo(12.96f)
                curveTo(11.5f, 12.55f, 11.84f, 12.21f, 12.25f, 12.21f)
                curveTo(12.66f, 12.21f, 13f, 12.54f, 13f, 12.95f)
                verticalLineTo(13.88f)
                curveTo(13f, 14.49f, 12.67f, 15.07f, 12.15f, 15.38f)
                lineTo(11.39f, 15.84f)
                curveTo(11.27f, 15.92f, 11.13f, 15.95f, 11f, 15.95f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(16f, 22.75f)
