    ...
    get() {
        ...
        _ClipboardTick = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(10.81f, 16.95f)
                curveTo(10.62f, 16.95f, 10.43f, 16.88f, 10.28f, 16.73f)
                lineTo(8.78f, 15.23f)
                curveTo(8.49f, 14.94f, 8.49f, 14.46f, 8.78f, 14.17f)
                curveTo(9.07f, 13.88f, 9.55f, 13.88f, 9.84f, 14.17f)
                lineTo(10.81f, 15.14f)
                lineTo(14.28f, 11.67f)
                curveTo(14.57f, 11.38f, 15.05f, 11.38f, 15.34f, 11.67f)
                curveTo(15.63f, 11.96f, 15.63f, 12.44f, 15.34f, 12.73f)
                lineTo(11.34f, 16.73f)
                curveTo(11.2f, 16.88f, 11f, 16.95f, 10.81f, 16.95f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(14f, 6.75f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(8.37f, 3.26f, 8.73f, 3.57f, 8.75f, 3.99f)
                ...
                curveTo(15.27f, 3.57f, 15.62f, 3.25f, 16.04f, 3.27f)
