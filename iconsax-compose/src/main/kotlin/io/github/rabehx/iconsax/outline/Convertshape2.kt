...
val Iconsax.Outline.Convertshape2: ImageVector
    get() {
        if (_Convertshape2 != null) {
            return _Convertshape2!!
        }
        _Convertshape2 = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(14.22f, 22.14f, 14.22f, 21.85f, 14.36f, 21.62f)
                lineTo(15.41f, 19.87f)
                curveTo(15.62f, 19.51f, 16.08f, 19.4f, 16.44f, 19.61f)
                curveTo(16.8f, 19.82f, 16.91f, 20.28f, 16.7f, 20.64f)
                lineTo(16.43f, 21.09f)
                curveTo(19.19f, 20.44f, 21.26f, 17.96f, 21.26f, 15f)
                curveTo(21.26f, 14.59f, 21.6f, 14.25f, 22.01f, 14.25f)
                curveTo(22.42f, 14.25f, 22.76f, 14.59f, 22.76f, 15f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(17.5f, 11.75f)
                curveTo(14.61f, 11.75f, 12.25f, 9.39f, 12.25f, 6.5f)
                curveTo(12.25f, 3.61f, 14.61f, 1.25f, 17.5f, 1.25f)
                curveTo(20.39f, 1.25f, 22.75f, 3.61f, 22.75f, 6.5f)
                curveTo(22.75f, 9.39f, 20.39f, 11.75f, 17.5f, 11.75f)
                close()
                moveTo(17.5f, 2.75f)
                curveTo(15.43f, 2.75f, 13.75f, 4.43f, 13.75f, 6.5f)
                curveTo(13.75f, 8.57f, 15.43f, 10.25f, 17.5f, 10.25f)
                curveTo(19.57f, 10.25f, 21.25f, 8.57f, 21.25f, 6.5f)
...
private var _Convertshape2: ImageVector? = null
