...
val Iconsax.Outline.DirectboxNotif: ImageVector
    get() {
        ...
        _DirectboxNotif = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(13.881f, 9.98f)
                horizontalLineTo(10.551f)
                curveTo(10.141f, 9.98f, 9.801f, 9.64f, 9.801f, 9.23f)
                curveTo(9.801f, 8.82f, 10.141f, 8.48f, 10.551f, 8.48f)
                horizontalLineTo(13.881f)
                curveTo(14.291f, 8.48f, 14.631f, 8.82f, 14.631f, 9.23f)
                curveTo(14.631f, 9.64f, 14.301f, 9.98f, 13.881f, 9.98f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(14.721f, 6.98f)
                horizontalLineTo(9.721f)
                curveTo(9.311f, 6.98f, 8.971f, 6.64f, 8.971f, 6.23f)
                curveTo(8.971f, 5.82f, 9.311f, 5.48f, 9.721f, 5.48f)
                horizontalLineTo(14.721f)
                curveTo(15.131f, 5.48f, 15.471f, 5.82f, 15.471f, 6.23f)
                curveTo(15.471f, 6.64f, 15.141f, 6.98f, 14.721f, 6.98f)
                close()
            }
        }.build()
