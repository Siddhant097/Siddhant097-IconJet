...
val Iconsax.Outline.ElementEqual: ImageVector
    get() {
        if (_ElementEqual != null) {
            return _ElementEqual!!
        }
        _ElementEqual = ImageVector.Builder(
            name = "Outline.ElementEqual",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(14.25f, 15.09f, 14.59f, 14.75f, 15f, 14.75f)
                horizontalLineTo(21f)
                curveTo(21.41f, 14.75f, 21.75f, 15.09f, 21.75f, 15.5f)
                curveTo(21.75f, 15.91f, 21.41f, 16.25f, 21f, 16.25f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(21f, 20.25f)
                ...
                curveTo(14.25f, 19.09f, 14.59f, 18.75f, 15f, 18.75f)
                horizontalLineTo(21f)
