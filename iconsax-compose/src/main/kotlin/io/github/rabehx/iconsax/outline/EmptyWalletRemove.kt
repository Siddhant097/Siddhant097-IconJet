...
val Iconsax.Outline.EmptyWalletRemove: ImageVector
    get() {
        if (_EmptyWalletRemove != null) {
            return _EmptyWalletRemove!!
        }
        _EmptyWalletRemove = ImageVector.Builder(
            name = "Outline.EmptyWalletRemove",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(2.73f, 16.66f, 2.43f, 16.69f, 2.17f, 16.57f)
...
private var _EmptyWalletRemove: ImageVector? = null
