...
val Iconsax.Outline.Fatrows: ImageVector
    get() {
        if (_Fatrows != null) {
            return _Fatrows!!
        }
        _Fatrows = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(14.82f, 1.25f, 15.75f, 2.23f, 15.75f, 4.23f)
                verticalLineTo(8.27f)
                curveTo(15.75f, 10.27f, 14.82f, 11.25f, 12.9f, 11.25f)
                close()
                moveTo(4.1f, 2.75f)
                ...
                horizontalLineTo(12.9f)
                curveTo(13.91f, 9.75f, 14.25f, 9.54f, 14.25f, 8.27f)
                verticalLineTo(4.23f)
                curveTo(14.25f, 2.96f, 13.91f, 2.75f, 12.9f, 2.75f)
                horizontalLineTo(4.1f)
                close()
            }
        }.build()
