...
val Iconsax.Outline.GalleryAdd: ImageVector
    get() {
        if (_GalleryAdd != null) {
            return _GalleryAdd!!
        }
        _GalleryAdd = ImageVector.Builder(
            name = "Outline.GalleryAdd",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(15.34f, 5.75f, 15f, 5.41f, 15f, 5f)
                curveTo(15f, 4.59f, 15.34f, 4.25f, 15.75f, 4.25f)
                horizontalLineTo(21.25f)
                curveTo(21.66f, 4.25f, 22f, 4.59f, 22f, 5f)
                curveTo(22f, 5.41f, 21.66f, 5.75f, 21.25f, 5.75f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(18.5f, 8.5f)
                curveTo(18.09f, 8.5f, 17.75f, 8.16f, 17.75f, 7.75f)
                verticalLineTo(2.25f)
                curveTo(17.75f, 1.84f, 18.09f, 1.5f, 18.5f, 1.5f)
                curveTo(18.91f, 1.5f, 19.25f, 1.84f, 19.25f, 2.25f)
                verticalLineTo(7.75f)
                curveTo(19.25f, 8.16f, 18.91f, 8.5f, 18.5f, 8.5f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(2.669f, 19.7f)
                ...
                curveTo(18.129f, 11.02f, 19.789f, 11.02f, 20.859f, 11.93f)
