...
val Iconsax.Outline.Hashtag1: ImageVector
    get() {
        if (_Hashtag1 != null) {
            return _Hashtag1!!
        }
        _Hashtag1 = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(7.93f, 17.75f, 6.25f, 16.07f, 6.25f, 14f)
                verticalLineTo(10f)
                curveTo(6.25f, 7.93f, 7.93f, 6.25f, 10f, 6.25f)
                horizontalLineTo(14f)
                curveTo(16.07f, 6.25f, 17.75f, 7.93f, 17.75f, 10f)
                verticalLineTo(14f)
                curveTo(17.75f, 16.07f, 16.07f, 17.75f, 14f, 17.75f)
                close()
                moveTo(10f, 7.75f)
                curveTo(8.76f, 7.75f, 7.75f, 8.76f, 7.75f, 10f)
                verticalLineTo(14f)
                curveTo(7.75f, 15.24f, 8.76f, 16.25f, 10f, 16.25f)
                horizontalLineTo(14f)
                curveTo(15.24f, 16.25f, 16.25f, 15.24f, 16.25f, 14f)
                verticalLineTo(10f)
                curveTo(16.25f, 8.76f, 15.24f, 7.75f, 14f, 7.75f)
                horizontalLineTo(10f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
