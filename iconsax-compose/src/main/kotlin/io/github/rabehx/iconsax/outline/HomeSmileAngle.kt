...
val Iconsax.Outline.HomeSmileAngle: ImageVector
    get() {
        if (_HomeSmileAngle != null) {
            return _HomeSmileAngle!!
        }
        _HomeSmileAngle = ImageVector.Builder(
            name = "Outline.HomeSmileAngle",
            defaultWidth = 1.dp,
            defaultHeight = 1.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(9.447f, 15.397f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = true, isPositiveArc = false, -0.894f, 1.205f)
                ...
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = true, isPositiveArc = false, -0.893f, -1.205f)
                arcTo(4.27f, 4.27f, 0f, isMoreThanHalf = false, isPositiveArc = true, 12f, 16.25f)
                arcToRelative(4.27f, 4.27f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.553f, -0.853f)
            }
            path(
