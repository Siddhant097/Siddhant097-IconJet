...
val Iconsax.Outline.Kanban: ImageVector
    get() {
        if (_Kanban != null) {
            return _Kanban!!
        }
        _Kanban = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(19.77f, 15.75f)
                horizontalLineTo(15.73f)
                curveTo(13.72f, 15.75f, 12.75f, 14.82f, 12.75f, 12.9f)
                verticalLineTo(4.1f)
                ...
                curveTo(22.75f, 14.82f, 21.77f, 15.75f, 19.77f, 15.75f)
                close()
                moveTo(15.73f, 2.75f)
                curveTo(14.46f, 2.75f, 14.25f, 3.09f, 14.25f, 4.1f)
                verticalLineTo(12.9f)
                curveTo(14.25f, 13.91f, 14.46f, 14.25f, 15.73f, 14.25f)
                horizontalLineTo(19.77f)
                curveTo(21.04f, 14.25f, 21.25f, 13.91f, 21.25f, 12.9f)
                verticalLineTo(4.1f)
