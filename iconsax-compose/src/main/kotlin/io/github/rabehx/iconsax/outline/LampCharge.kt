...
val Iconsax.Outline.LampCharge: ImageVector
    get() {
        if (_LampCharge != null) {
            return _LampCharge!!
        }
        _LampCharge = ImageVector.Builder(
            name = "Outline.LampCharge",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(12f, 13.85f)
                curveTo(11.87f, 13.85f, 11.74f, 13.82f, 11.63f, 13.75f)
                curveTo(11.27f, 13.54f, 11.15f, 13.08f, 11.35f, 12.73f)
                lineTo(12.2f, 11.25f)
                horizontalLineTo(11.36f)
                curveTo(10.86f, 11.25f, 10.45f, 11.03f, 10.23f, 10.66f)
                curveTo(10.01f, 10.28f, 10.03f, 9.82f, 10.28f, 9.38f)
                lineTo(11.35f, 7.52f)
                curveTo(11.56f, 7.16f, 12.02f, 7.04f, 12.37f, 7.24f)
                curveTo(12.73f, 7.45f, 12.85f, 7.91f, 12.65f, 8.26f)
                lineTo(11.8f, 9.75f)
                horizontalLineTo(12.64f)
                curveTo(13.14f, 9.75f, 13.55f, 9.97f, 13.77f, 10.34f)
                curveTo(13.99f, 10.72f, 13.97f, 11.18f, 13.72f, 11.62f)
                lineTo(12.65f, 13.48f)
                curveTo(12.51f, 13.72f, 12.26f, 13.85f, 12f, 13.85f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
