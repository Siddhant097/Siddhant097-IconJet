...
val Iconsax.Outline.Link1: ImageVector
    get() {
        if (_Link1 != null) {
            return _Link1!!
        }
        _Link1 = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(1.75f, 11.36f, 1.24f, 9.95f, 1.24f, 8.5f)
                curveTo(1.24f, 5.05f, 4.04f, 2.25f, 7.49f, 2.25f)
                horizontalLineTo(12.49f)
                curveTo(15.94f, 2.25f, 18.74f, 5.05f, 18.74f, 8.5f)
                curveTo(18.74f, 11.95f, 15.95f, 14.75f, 12.5f, 14.75f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(16.5f, 21.75f)
