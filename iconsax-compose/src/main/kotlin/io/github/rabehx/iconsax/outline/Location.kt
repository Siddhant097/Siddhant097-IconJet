...
val Iconsax.Outline.Location: ImageVector
    get() {
        if (_Location != null) {
            return _Location!!
        }
        _Location = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(12.001f, 14.17f)
                curveTo(9.871f, 14.17f, 8.131f, 12.44f, 8.131f, 10.3f)
                curveTo(8.131f, 8.16f, 9.871f, 6.44f, 12.001f, 6.44f)
                curveTo(14.131f, 6.44f, 15.871f, 8.17f, 15.871f, 10.31f)
                curveTo(15.871f, 12.45f, 14.131f, 14.17f, 12.001f, 14.17f)
                close()
                moveTo(12.001f, 7.94f)
                curveTo(10.701f, 7.94f, 9.631f, 9f, 9.631f, 10.31f)
                curveTo(9.631f, 11.62f, 10.691f, 12.68f, 12.001f, 12.68f)
                curveTo(13.311f, 12.68f, 14.371f, 11.62f, 14.371f, 10.31f)
                curveTo(14.371f, 9f, 13.301f, 7.94f, 12.001f, 7.94f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(12f, 22.76f)
