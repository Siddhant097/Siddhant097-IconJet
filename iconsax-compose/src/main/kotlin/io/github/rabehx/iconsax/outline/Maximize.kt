...
val Iconsax.Outline.Maximize: ImageVector
    get() {
        if (_Maximize != null) {
            return _Maximize!!
        }
        _Maximize = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(18f, 18.75f)
                curveTo(17.809f, 18.75f, 17.619f, 18.68f, 17.469f, 18.53f)
                lineTo(5.469f, 6.53f)
                curveTo(5.179f, 6.24f, 5.179f, 5.76f, 5.469f, 5.47f)
                curveTo(5.759f, 5.18f, 6.239f, 5.18f, 6.529f, 5.47f)
                lineTo(18.529f, 17.47f)
                curveTo(18.819f, 17.76f, 18.819f, 18.24f, 18.529f, 18.53f)
                curveTo(18.379f, 18.68f, 18.19f, 18.75f, 18f, 18.75f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(6f, 10.75f)
                ...
                verticalLineTo(6f)
                curveTo(5.25f, 5.59f, 5.59f, 5.25f, 6f, 5.25f)
                horizontalLineTo(10f)
