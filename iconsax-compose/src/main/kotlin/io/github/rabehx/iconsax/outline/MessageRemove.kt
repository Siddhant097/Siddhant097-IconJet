...
val Iconsax.Outline.MessageRemove: ImageVector
    get() {
        if (_MessageRemove != null) {
            return _MessageRemove!!
        }
        _MessageRemove = ImageVector.Builder(
            name = "Outline.MessageRemove",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(6.07f, 19.29f)
                curveTo(5.88f, 19.29f, 5.69f, 19.22f, 5.54f, 19.07f)
                lineTo(3.43f, 16.96f)
                curveTo(3.14f, 16.67f, 3.14f, 16.19f, 3.43f, 15.9f)
                curveTo(3.72f, 15.61f, 4.2f, 15.61f, 4.49f, 15.9f)
                lineTo(6.6f, 18.01f)
                curveTo(6.89f, 18.3f, 6.89f, 18.78f, 6.6f, 19.07f)
                curveTo(6.45f, 19.22f, 6.26f, 19.29f, 6.07f, 19.29f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(3.931f, 19.32f)
                curveTo(3.741f, 19.32f, 3.551f, 19.25f, 3.401f, 19.1f)
                curveTo(3.111f, 18.81f, 3.111f, 18.33f, 3.401f, 18.04f)
                lineTo(5.511f, 15.93f)
                curveTo(5.801f, 15.64f, 6.281f, 15.64f, 6.571f, 15.93f)
                curveTo(6.861f, 16.22f, 6.861f, 16.7f, 6.571f, 16.99f)
                lineTo(4.461f, 19.1f)
                curveTo(4.311f, 19.25f, 4.121f, 19.32f, 3.931f, 19.32f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(15.5f, 11.25f)
