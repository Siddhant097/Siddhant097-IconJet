...
val Iconsax.Outline.MoneyTick: ImageVector
    get() {
        if (_MoneyTick != null) {
            return _MoneyTick!!
        }
        _MoneyTick = ImageVector.Builder(
            name = "Outline.MoneyTick",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(4.429f, 19.74f)
                curveTo(4.239f, 19.74f, 4.049f, 19.67f, 3.899f, 19.52f)
                lineTo(2.909f, 18.53f)
                curveTo(2.619f, 18.24f, 2.619f, 17.76f, 2.909f, 17.47f)
                curveTo(3.199f, 17.18f, 3.679f, 17.18f, 3.969f, 17.47f)
                lineTo(4.449f, 17.95f)
                lineTo(6.049f, 16.47f)
                curveTo(6.349f, 16.19f, 6.829f, 16.21f, 7.109f, 16.51f)
                curveTo(7.389f, 16.81f, 7.369f, 17.29f, 7.069f, 17.57f)
                lineTo(4.939f, 19.54f)
                curveTo(4.789f, 19.67f, 4.609f, 19.74f, 4.429f, 19.74f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(17f, 20.75f)
