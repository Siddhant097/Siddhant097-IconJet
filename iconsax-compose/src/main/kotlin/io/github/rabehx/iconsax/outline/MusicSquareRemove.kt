...
val Iconsax.Outline.MusicSquareRemove: ImageVector
    get() {
        if (_MusicSquareRemove != null) {
            return _MusicSquareRemove!!
        }
        _MusicSquareRemove = ImageVector.Builder(
            name = "Outline.MusicSquareRemove",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(21.75f, 14.71f, 21.74f, 15.05f, 21.72f, 15.38f)
                curveTo(21.7f, 15.68f, 21.5f, 15.94f, 21.21f, 16.04f)
                curveTo(20.92f, 16.14f, 20.61f, 16.05f, 20.4f, 15.83f)
                curveTo(19.8f, 15.15f, 18.92f, 14.75f, 17.99f, 14.75f)
                curveTo(16.2f, 14.75f, 14.74f, 16.21f, 14.74f, 18f)
                curveTo(14.74f, 18.59f, 14.9f, 19.17f, 15.21f, 19.67f)
                curveTo(15.37f, 19.95f, 15.58f, 20.2f, 15.82f, 20.41f)
                curveTo(16.05f, 20.61f, 16.14f, 20.93f, 16.04f, 21.21f)
                curveTo(15.94f, 21.5f, 15.68f, 21.7f, 15.38f, 21.72f)
                curveTo(15.06f, 21.74f, 14.72f, 21.75f, 14.35f, 21.75f)
                close()
                moveTo(8.65f, 2.75f)
                ...
                curveTo(13.45f, 19.57f, 13.25f, 18.8f, 13.25f, 18f)
                curveTo(13.25f, 15.38f, 15.38f, 13.25f, 18f, 13.25f)
                curveTo(18.8f, 13.25f, 19.57f, 13.45f, 20.25f, 13.81f)
                verticalLineTo(8.65f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(12.6f, 5.86f, 12.45f, 5.82f, 12.15f, 5.9f)
                lineTo(9.26f, 6.69f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                lineTo(13.29f, 6.66f)
                curveTo(13.691f, 6.56f, 14.101f, 6.79f, 14.21f, 7.19f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(19.15f, 21.26f, 20.19f, 20.67f, 20.78f, 19.69f)
                curveTo(21.09f, 19.18f, 21.25f, 18.61f, 21.25f, 18.01f)
                curveTo(21.25f, 17.21f, 20.95f, 16.44f, 20.41f, 15.84f)
                curveTo(19.81f, 15.14f, 18.93f, 14.75f, 18f, 14.75f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(19.07f, 19.79f)
                curveTo(18.88f, 19.79f, 18.69f, 19.72f, 18.54f, 19.57f)
                lineTo(16.43f, 17.46f)
                curveTo(16.14f, 17.17f, 16.14f, 16.69f, 16.43f, 16.4f)
                curveTo(16.72f, 16.11f, 17.2f, 16.11f, 17.49f, 16.4f)
                lineTo(19.6f, 18.51f)
                curveTo(19.89f, 18.8f, 19.89f, 19.28f, 19.6f, 19.57f)
                curveTo(19.45f, 19.72f, 19.26f, 19.79f, 19.07f, 19.79f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(16.931f, 19.82f)
                curveTo(16.741f, 19.82f, 16.551f, 19.75f, 16.401f, 19.6f)
                curveTo(16.111f, 19.31f, 16.111f, 18.83f, 16.401f, 18.54f)
                lineTo(18.511f, 16.43f)
                curveTo(18.801f, 16.14f, 19.281f, 16.14f, 19.571f, 16.43f)
                curveTo(19.861f, 16.72f, 19.861f, 17.2f, 19.571f, 17.49f)
                lineTo(17.461f, 19.6f)
                curveTo(17.311f, 19.75f, 17.121f, 19.82f, 16.931f, 19.82f)
                close()
            }
        }.build()
...
private var _MusicSquareRemove: ImageVector? = null
