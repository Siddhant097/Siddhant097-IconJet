...
val Iconsax.Outline.Note2: ImageVector
    get() {
        if (_Note2 != null) {
            return _Note2!!
        }
        _Note2 = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(17.84f, 18.91f, 19.19f, 17.72f, 19.95f, 14.45f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(9.149f, 4.31f, 9.429f, 4.42f, 9.599f, 4.65f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(17.489f, 10.51f)
                curveTo(17.429f, 10.51f, 17.369f, 10.5f, 17.299f, 10.49f)
                lineTo(12.449f, 9.26f)
                curveTo(12.049f, 9.16f, 11.809f, 8.75f, 11.909f, 8.35f)
                curveTo(12.009f, 7.95f, 12.419f, 7.71f, 12.819f, 7.81f)
                lineTo(17.669f, 9.04f)
                curveTo(18.069f, 9.14f, 18.309f, 9.55f, 18.209f, 9.95f)
                curveTo(18.129f, 10.28f, 17.819f, 10.51f, 17.489f, 10.51f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(14.559f, 13.89f)
                curveTo(14.499f, 13.89f, 14.439f, 13.88f, 14.369f, 13.87f)
                lineTo(11.459f, 13.13f)
                curveTo(11.059f, 13.03f, 10.819f, 12.62f, 10.919f, 12.22f)
                curveTo(11.019f, 11.82f, 11.429f, 11.58f, 11.829f, 11.68f)
                lineTo(14.739f, 12.42f)
                curveTo(15.139f, 12.52f, 15.379f, 12.93f, 15.279f, 13.33f)
                curveTo(15.199f, 13.67f, 14.899f, 13.89f, 14.559f, 13.89f)
                close()
            }
        }.build()
