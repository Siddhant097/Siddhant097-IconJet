...
val Iconsax.Outline.RepeateOne: ImageVector
    get() {
        if (_RepeateOne != null) {
            return _RepeateOne!!
        }
        _RepeateOne = ImageVector.Builder(
            name = "Outline.RepeateOne",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(12.25f, 15.42f)
                curveTo(11.84f, 15.42f, 11.5f, 15.08f, 11.5f, 14.67f)
                verticalLineTo(11.28f)
                lineTo(11.311f, 11.49f)
                curveTo(11.031f, 11.8f, 10.561f, 11.82f, 10.25f, 11.55f)
                curveTo(9.94f, 11.28f, 9.92f, 10.8f, 10.191f, 10.49f)
                lineTo(11.691f, 8.82f)
                curveTo(11.901f, 8.59f, 12.231f, 8.51f, 12.521f, 8.62f)
                curveTo(12.811f, 8.73f, 13f, 9.01f, 13f, 9.32f)
                verticalLineTo(14.67f)
                curveTo(13f, 15.09f, 12.66f, 15.42f, 12.25f, 15.42f)
                close()
            }
        }.build()
