...
val Iconsax.Outline.Settings: ImageVector
    get() {
        if (_Settings != null) {
            return _Settings!!
        }
        _Settings = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(12f, 17.25f)
                curveTo(9.11f, 17.25f, 6.75f, 14.9f, 6.75f, 12f)
                curveTo(6.75f, 9.1f, 9.11f, 6.75f, 12f, 6.75f)
                curveTo(14.89f, 6.75f, 17.25f, 9.1f, 17.25f, 12f)
                curveTo(17.25f, 14.9f, 14.89f, 17.25f, 12f, 17.25f)
                close()
                moveTo(12f, 8.25f)
