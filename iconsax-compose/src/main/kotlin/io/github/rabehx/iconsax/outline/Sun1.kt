...
val Iconsax.Outline.Sun1: ImageVector
    get() {
        if (_Sun1 != null) {
            return _Sun1!!
        }
        _Sun1 = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(12f, 19.25f)
                curveTo(8f, 19.25f, 4.75f, 16f, 4.75f, 12f)
                curveTo(4.75f, 8f, 8f, 4.75f, 12f, 4.75f)
                curveTo(16f, 4.75f, 19.25f, 8f, 19.25f, 12f)
                curveTo(19.25f, 16f, 16f, 19.25f, 12f, 19.25f)
                close()
                moveTo(12f, 6.25f)
                curveTo(8.83f, 6.25f, 6.25f, 8.83f, 6.25f, 12f)
                curveTo(6.25f, 15.17f, 8.83f, 17.75f, 12f, 17.75f)
                curveTo(15.17f, 17.75f, 17.75f, 15.17f, 17.75f, 12f)
