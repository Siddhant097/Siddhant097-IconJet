...
val Iconsax.Outline.TextalignJustifyleft: ImageVector
    get() {
        if (_TextalignJustifyleft != null) {
            return _TextalignJustifyleft!!
        }
        _TextalignJustifyleft = ImageVector.Builder(
            name = "Outline.TextalignJustifyleft",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(12.41f, 3.75f, 12.75f, 4.09f, 12.75f, 4.5f)
                curveTo(12.75f, 4.91f, 12.41f, 5.25f, 12f, 5.25f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(12f, 10.25f)
...
private var _TextalignJustifyleft: ImageVector? = null
