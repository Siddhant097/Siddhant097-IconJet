...
val Iconsax.Outline.ToggleOffCircle: ImageVector
    get() {
        ...
        _ToggleOffCircle = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(10f, 16.75f)
                curveTo(7.38f, 16.75f, 5.25f, 14.62f, 5.25f, 12f)
                curveTo(5.25f, 9.38f, 7.38f, 7.25f, 10f, 7.25f)
                curveTo(12.62f, 7.25f, 14.75f, 9.38f, 14.75f, 12f)
                curveTo(14.75f, 14.62f, 12.62f, 16.75f, 10f, 16.75f)
                close()
                moveTo(10f, 8.75f)
                curveTo(8.21f, 8.75f, 6.75f, 10.21f, 6.75f, 12f)
                curveTo(6.75f, 13.79f, 8.21f, 15.25f, 10f, 15.25f)
                curveTo(11.79f, 15.25f, 13.25f, 13.79f, 13.25f, 12f)
                curveTo(13.25f, 10.21f, 11.79f, 8.75f, 10f, 8.75f)
                close()
            }
        }.build()
