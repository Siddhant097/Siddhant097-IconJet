...
val Iconsax.Outline.TruckFast: ImageVector
    get() {
        if (_TruckFast != null) {
            return _TruckFast!!
        }
        _TruckFast = ImageVector.Builder(
            name = "Outline.TruckFast",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                horizontalLineTo(6f)
                curveTo(4.82f, 2.75f, 3.74f, 3.39f, 3.16f, 4.42f)
                curveTo(2.96f, 4.78f, 2.5f, 4.91f, 2.14f, 4.71f)
                curveTo(1.78f, 4.51f, 1.65f, 4.05f, 1.85f, 3.69f)
                curveTo(2.69f, 2.19f, 4.28f, 1.25f, 6f, 1.25f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(1.25f, 16.59f, 1.59f, 16.25f, 2f, 16.25f)
                curveTo(2.41f, 16.25f, 2.75f, 16.59f, 2.75f, 17f)
                ...
                curveTo(17.27f, 17.25f, 18.33f, 18.1f, 18.66f, 19.25f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(8f, 8.75f)
                horizontalLineTo(2f)
                curveTo(1.59f, 8.75f, 1.25f, 8.41f, 1.25f, 8f)
                curveTo(1.25f, 7.59f, 1.59f, 7.25f, 2f, 7.25f)
                horizontalLineTo(8f)
                curveTo(8.41f, 7.25f, 8.75f, 7.59f, 8.75f, 8f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(1.25f, 10.59f, 1.59f, 10.25f, 2f, 10.25f)
                horizontalLineTo(6f)
                curveTo(6.41f, 10.25f, 6.75f, 10.59f, 6.75f, 11f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                horizontalLineTo(4f)
                curveTo(4.41f, 13.25f, 4.75f, 13.59f, 4.75f, 14f)
                curveTo(4.75f, 14.41f, 4.41f, 14.75f, 4f, 14.75f)
                close()
            }
        }.build()
