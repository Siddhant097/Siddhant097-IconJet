...
val Iconsax.Outline.TruckTime: ImageVector
    get() {
        if (_TruckTime != null) {
            return _TruckTime!!
        }
        _TruckTime = ImageVector.Builder(
            name = "Outline.TruckTime",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(5f, 9.75f)
                curveTo(2.38f, 9.75f, 0.25f, 7.62f, 0.25f, 5f)
                ...
                curveTo(9.75f, 6.36f, 9.16f, 7.66f, 8.13f, 8.56f)
                curveTo(7.26f, 9.33f, 6.15f, 9.75f, 5f, 9.75f)
                close()
                moveTo(5f, 1.75f)
                curveTo(4.26f, 1.75f, 3.56f, 2f, 2.97f, 2.47f)
                curveTo(2.2f, 3.08f, 1.75f, 4.01f, 1.75f, 5f)
                curveTo(1.75f, 6.79f, 3.21f, 8.25f, 5f, 8.25f)
                curveTo(5.78f, 8.25f, 6.54f, 7.96f, 7.15f, 7.44f)
                curveTo(7.85f, 6.82f, 8.25f, 5.94f, 8.25f, 5f)
                curveTo(8.25f, 3.21f, 6.79f, 1.75f, 5f, 1.75f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(4f, 6.75f)
                curveTo(3.75f, 6.75f, 3.5f, 6.62f, 3.36f, 6.39f)
                curveTo(3.15f, 6.03f, 3.26f, 5.57f, 3.62f, 5.36f)
                lineTo(4.51f, 4.83f)
                verticalLineTo(3.75f)
                curveTo(4.51f, 3.34f, 4.85f, 3f, 5.26f, 3f)
                curveTo(5.67f, 3f, 6.01f, 3.34f, 6.01f, 3.75f)
                verticalLineTo(5.25f)
                curveTo(6.01f, 5.51f, 5.87f, 5.76f, 5.65f, 5.89f)
                lineTo(4.4f, 6.64f)
                curveTo(4.26f, 6.72f, 4.13f, 6.75f, 4f, 6.75f)
                close()
            }
        }.build()
