...
val Iconsax.Outline.UserAdd: ImageVector
    get() {
        if (_UserAdd != null) {
            return _UserAdd!!
        }
        _UserAdd = ImageVector.Builder(
            name = "Outline.UserAdd",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(18f, 20.26f)
                curveTo(17.59f, 20.26f, 17.25f, 19.92f, 17.25f, 19.51f)
                verticalLineTo(16.52f)
                curveTo(17.25f, 16.11f, 17.59f, 15.77f, 18f, 15.77f)
                curveTo(18.41f, 15.77f, 18.75f, 16.11f, 18.75f, 16.52f)
                verticalLineTo(19.51f)
                curveTo(18.75f, 19.93f, 18.41f, 20.26f, 18f, 20.26f)
                close()
            }
        }.build()
