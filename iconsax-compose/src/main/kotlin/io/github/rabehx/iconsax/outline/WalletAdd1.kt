...
val Iconsax.Outline.WalletAdd1: ImageVector
    get() {
        if (_WalletAdd1 != null) {
            return _WalletAdd1!!
        }
        _WalletAdd1 = ImageVector.Builder(
            name = "Outline.WalletAdd1",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(9.09f, 16.19f, 8.75f, 15.85f, 8.75f, 15.44f)
                curveTo(8.75f, 15.03f, 9.09f, 14.69f, 9.5f, 14.69f)
                horizontalLineTo(14.5f)
                curveTo(14.91f, 14.69f, 15.25f, 15.03f, 15.25f, 15.44f)
                curveTo(15.25f, 15.85f, 14.91f, 16.19f, 14.5f, 16.19f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(12f, 18.75f)
                ...
                verticalLineTo(13f)
                curveTo(11.25f, 12.59f, 11.59f, 12.25f, 12f, 12.25f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(5.2f, 10.46f)
                curveTo(5.01f, 10.46f, 4.82f, 10.38f, 4.67f, 10.24f)
                curveTo(4.46f, 10.03f, 4.39f, 9.7f, 4.51f, 9.42f)
                lineTo(6.37f, 4.98f)
                ...
                lineTo(10.66f, 9.62f)
                curveTo(10.54f, 9.89f, 10.27f, 10.07f, 9.97f, 10.07f)
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(17.7f, 10.13f, 17.29f, 10.07f, 16.87f, 10.07f)
                horizontalLineTo(9.97f)
                curveTo(9.72f, 10.07f, 9.48f, 9.94f, 9.34f, 9.73f)
                curveTo(9.21f, 9.52f, 9.18f, 9.25f, 9.28f, 9.02f)
                lineTo(12.18f, 2.29f)
                curveTo(12.33f, 1.93f, 12.77f, 1.69f, 13.14f, 1.81f)
                curveTo(13.26f, 1.85f, 13.37f, 1.9f, 13.49f, 1.95f)
                lineTo(15.85f, 2.94f)
                curveTo(17.23f, 3.51f, 18.15f, 4.11f, 18.75f, 4.83f)
                curveTo(18.87f, 4.97f, 18.97f, 5.12f, 19.06f, 5.27f)
                curveTo(19.17f, 5.44f, 19.27f, 5.65f, 19.34f, 5.86f)
                curveTo(19.37f, 5.93f, 19.42f, 6.06f, 19.45f, 6.2f)
                curveTo(19.73f, 7.14f, 19.59f, 8.31f, 18.99f, 9.81f)
                ...
                curveTo(17.17f, 5.26f, 16.41f, 4.78f, 15.28f, 4.32f)
                lineTo(13.3f, 3.49f)
                lineTo(11.11f, 8.57f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveTo(17.69f, 10.13f, 17.28f, 10.07f, 16.86f, 10.07f)
                horizontalLineTo(7.12f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
...
private var _WalletAdd1: ImageVector? = null
