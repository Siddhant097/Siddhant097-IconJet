...
val Iconsax.Outline.WalletCheck: ImageVector
    get() {
        if (_WalletCheck != null) {
            return _WalletCheck!!
        }
        _WalletCheck = ImageVector.Builder(
            name = "Outline.WalletCheck",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(4.429f, 20.74f)
                curveTo(4.239f, 20.74f, 4.049f, 20.67f, 3.899f, 20.52f)
                lineTo(2.909f, 19.53f)
                curveTo(2.619f, 19.24f, 2.619f, 18.76f, 2.909f, 18.47f)
                curveTo(3.199f, 18.18f, 3.679f, 18.18f, 3.969f, 18.47f)
                lineTo(4.449f, 18.95f)
                lineTo(6.049f, 17.47f)
                curveTo(6.349f, 17.19f, 6.829f, 17.21f, 7.109f, 17.51f)
                curveTo(7.389f, 17.81f, 7.369f, 18.29f, 7.069f, 18.57f)
                lineTo(4.939f, 20.54f)
                curveTo(4.789f, 20.67f, 4.609f, 20.74f, 4.429f, 20.74f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(6.19f, 7.81f)
...
private var _WalletCheck: ImageVector? = null
