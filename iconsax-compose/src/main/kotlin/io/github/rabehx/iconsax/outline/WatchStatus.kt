...
val Iconsax.Outline.WatchStatus: ImageVector
    get() {
        if (_WatchStatus != null) {
            return _WatchStatus!!
        }
        _WatchStatus = ImageVector.Builder(
            name = "Outline.WatchStatus",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                verticalLineTo(14f)
                curveTo(12.75f, 14.42f, 12.41f, 14.75f, 12f, 14.75f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(15f, 14.75f)
                ...
                verticalLineTo(14f)
                curveTo(15.75f, 14.42f, 15.42f, 14.75f, 15f, 14.75f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000))) {
                moveTo(9f, 14.75f)
                ...
                verticalLineTo(14f)
                curveTo(9.75f, 14.42f, 9.41f, 14.75f, 9f, 14.75f)
                close()
            }
        }.build()
